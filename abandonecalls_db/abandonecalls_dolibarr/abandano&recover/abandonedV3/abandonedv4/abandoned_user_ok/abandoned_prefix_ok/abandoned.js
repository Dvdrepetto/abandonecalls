            ...
            data.forEach(call => {
                ...
                if (call.status === 'processing') {
                    ...
                    actions_block = `<div class="btn-group">
                        ...
                        <button class="btn btn-info btn-xs btn-copy-number" data-dial-string="${call.dial_string}" title="Copiar número para marcar: ${call.dial_string}"><i class="fa fa-clipboard"></i></button>
                    </div>`;
                }
